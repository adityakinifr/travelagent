...
def run_examples():
    ...
    result_2 = agent.create_itinerary(trip_request_2)
    print_itinerary(result_2)
    
    # Example 3: Budget backpacking trip
    print("\n" + "="*60)
    print("EXAMPLE 3: Budget Backpacking Trip")
    print("="*60)
    ...
    result_3 = agent.create_itinerary(trip_request_3)
    print_itinerary(result_3)
